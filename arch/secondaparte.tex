...
Nella pipeline i lavori sono affidati a degli \bt{esecutori} che possono
di diversi tipi:
...
data dal \tit{ compilatore }, ( per esempio un buon compilatore CISC può rendere quest'architettura
