...
\begin{enumerate}
	...
	\item Operand Store
\end{enumerate}
\begin{smartdiagram}[circular diagram:clockwise]{Instruction Address Calculation,
...
\input{sub/mem_tab}
Si dice di una memoria che e' volatile o no quando: se si toglie l'alimentazione
si cancella l'intero contenuto della memoria. 
...
\subsubsection{Codice correzione errore}
Tipi di errori: 
...
Quando un dato viene creato assieme ad esso si crea una sua 'impronta digitale' che verra'
utilizzata per comparare la validita' del dato.
\end{document}
